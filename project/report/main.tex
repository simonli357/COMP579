...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/rainbow_8Regular.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/rainbow_8Extended.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/rainbow_A_seed.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/rainbow_E_seed.png}
